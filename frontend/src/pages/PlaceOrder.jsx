...
function PlaceOrder() {
  ...
  return (
<div className='w-[100vw] min-h-[100vh] bg-gradient-to-l from-[#141414] to-[#0c2025] flex items-center justify-center flex-col lg:flex-row gap-[40px] lg:gap-[50px] py-[40px] pb-[110px] md:pb-[40px]'>        <div className='lg:w-[50%] w-[100%] flex items-center justify-center mt-[50px] lg:mt-[0px] '>
        ...
        <div className='flex justify-center w-full mt-[15px]'>
          <button type='submit' form='deliveryForm' className='text-[15px] md:text-[18px] active:bg-slate-500 cursor-pointer bg-[#3bcee848] py-[10px] px-[35px] md:px-[50px] rounded-2xl text-white flex items-center justify-center gap-[20px] border-[1px] border-[#80808049]' >{loading? <Loading/> : "PLACE ORDER"}</button>
         </div>
            </div>
        </div>
