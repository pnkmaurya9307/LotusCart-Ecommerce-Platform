...
<p className=' w-[80%] md:w-[60%] text-[20px] font-semibold pl-[5px] text-[white]'>{productData.description}</p>                <div className='flex flex-col gap-[10px] my-[10px] '>
 ...
 <div className='w-[80%] md:h-[150px] h-[220px] bg-[#3336397c] border text-white text-[13px] md:text-[15px] lg:text-[20px] px-[12px] md:px-[20px] lg:ml-[100px] ml-[20px] py-[15px] overflow-x-hidden overflow-y-auto'>
<p className='w-[95%] text-[15px] md:text-[15px] lg:text-[18px] text-left leading-relaxed break-words'> {productData.detailedDescription || productData.description}</p>
     </div>
